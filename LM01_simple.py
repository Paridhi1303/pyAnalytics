...
y_pred2
y_pred - y_pred2 #comes out to be zero because we are essentially doing the same thing
...
x= sm.add_constant(x)  #constant term of 1 gets appended to the array
x
model3 = sm.OLS(y,x)
model3
results = model3.fit()
...
!pip install RegscorePy #to find out the AIC and BIC values
import RegscorePy
#aic(y, y_pred, p)
