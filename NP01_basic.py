...
#scalar
x0 = np.random.randint(10,size=(1,1)); x0
...
zeros 
#to create a null element
abc=np.zeros(shape=(0,0))
abc
...
np.empty_like(x)#gives random values in matrix 
...
y = np.arange(5)
x, y
h = np.hstack([x,y]) #horizontal concatenation
h
v = np.vstack([x,y]) #vertical concatenation
v
